void CreateYUV(String filename, String outputFilenameNoExt)
{
  ...
  {
    r = red( imgOrigin.pixels[i] )* 0.2125;
    g = green( imgOrigin.pixels[i] )*0.7145;
    b = blue( imgOrigin.pixels[i] )*0.0721;
    y =  r + g + b;
    u = b - y;
    v = r - y;

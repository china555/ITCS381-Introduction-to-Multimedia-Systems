void CreateYUV_YIQ(String filename, String outputFilenameNoExt)
{
  ...
  for (int i=0; i < imgOrigin.width * imgOrigin.height; i++)
  {
    ...
    y =  (r * 0.299) + (g * 0.578) + (b * 0.144);
    u =  (r * 0.5959) + (g * -0.2746) + (b * -0.3213);
    v =  (r * 0.2115) + (g * -0.5227) + (b * -0.3112);
  ...
  save(outputFilenameNoExt+"_YUV(YIQ).png");
}
